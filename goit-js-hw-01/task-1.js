...
let password = prompt("Введите параль");
...
let qtOrder = prompt("количество дроидов которые пользователь хочет купить");

if (qtOrder === null) {
  message = "Отменено пользователем!";
} else {
  totalPrice = qtOrder * pricePerDroid;

  if (totalPrice > credits) {
    message = "Недостаточно средств на счету!";
  } else {
    message = `Вы купили ${qtOrder} дроидов, на счету осталось ${credits - totalPrice} кредитов.`;
  }
}
...
switch (country) {
  case "китай":
    coast = "100 кредитов";
    message = `Доставка в ${country[0].toUpperCase() + country.slice(1)} будет стоить ${coast}`;
        break;
