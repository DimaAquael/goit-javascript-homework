...
const message = `${companyName} has ${repairBots + defenceBots} bots in stoc`;
...
console.log("2" > "12"); //false меньший индекс
...
console.log("0" == false); //false не верно

console.log("0" === false); //false

console.log("Papaya" < "papaya"); //false меньший индекс
...
// Отрефактори код так, чтобы в переменную value присваивалось значение переменной incomingValue, если оно не равно
// undefined или null.В противном случае должно присваиваться значение defaultValue.
